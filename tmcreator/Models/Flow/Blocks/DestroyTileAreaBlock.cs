...
public static class DestroyTileAreaBlock
{
    public static BlockDefinition Create() => new()
    {
        Id = "destroy_tile_area",
        Name = "范围破坏方块",
        ...
        Params =
        {
            ...
            new() { Name = "tile_id", Label = "方块ID(-1为任意)", Type = ParamType.Number, DefaultValue = "-1" }
        },
        AppendStatement = Append,
        RequiredHelpers = { FlowHelperNames.DestroyTileArea }
    };
    ...
    private static void Append(FlowGenerationContext context, BlockInstance block, int indent)
    {
        ...
        string tileId = context.GetIntExpression(block, "tile_id", "-1");
        ...
        context.AppendLine(indent, $"Flow_DestroyTileArea({startVar}, {endVar}, {tileId});");
    }
}
