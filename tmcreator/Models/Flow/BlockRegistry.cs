...
public static class BlockRegistry
{
    public static List<BlockDefinition> AllBlocks { get; } = new()
    {
        ...
        SetWeaponHoldoutOffsetBlock.Create(),
        SpawnProjectileFromCoordinateBlock.Create(),
        SpawnNpcAtCoordinateBlock.Create(),
        PlaceTileAreaBlock.Create(),
        DestroyTileAreaBlock.Create(),
        StartInvasionBlock.Create(),

        ValueEventTargetPositionBlock.Create(),
        ValueSourcePositionBlock.Create(),
        ValueNearestPlayerPositionBlock.Create(),
